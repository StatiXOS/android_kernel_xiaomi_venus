...
XIAOMI_DEVICE_QGKI_FRAG=${CONFIGS_DIR}/${DEVICE}_QGKI.config
XIAOMI_GKI_FRAG=${CONFIGS_DIR}/xiaomi_GKI.config
XIAOMI_QGKI_FRAG=${CONFIGS_DIR}/xiaomi_QGKI.config
...
export ARCH CROSS_COMPILE REAL_CC HOSTCC HOSTLD HOSTAR KERN_SRC KERN_OUT \
	CONFIGS_DIR BASE_DEFCONFIG XIAOMI_DEVICE_QGKI_FRAG XIAOMI_GKI_FRAG XIAOMI_QGKI_FRAG QCOM_GKI_FRAG QCOM_QGKI_FRAG QCOM_DEBUG_FRAG
